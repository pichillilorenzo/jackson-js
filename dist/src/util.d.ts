import { ClassType, JsonAnnotationDecorator, JsonAnnotationOptions, JsonParserOptions, JsonStringifierOptions } from './@types';
...
export declare const getMetadata: <T extends JsonAnnotationOptions>(metadataKey: string, target: Record<string, any>, propertyKey?: string | symbol, options?: JsonParserOptions | JsonStringifierOptions) => T;
export declare const hasMetadata: <T extends JsonAnnotationOptions>(metadataKey: string, target: Record<string, any>, propertyKey?: string | symbol, options?: JsonParserOptions | JsonStringifierOptions) => boolean;
